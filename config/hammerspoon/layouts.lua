...
local layout_zoom_meeting = {
    {
      name = {"Zoom"},
      func = function(index, win)
          pushWindow(win,0.4,0,0.6,0.75) --top left (60% x 60%)
      end
    },
    {
      name = {"Camo Studio"},
      func = function(index, win)
          pushWindow(win,0.4,0.75,0.6,0.25) --bottom right
      end
    },
    {
      name = {"Firefox"},
      func = function(index, win)
          pushWindow(win,0,0.25,0.6,0.75) --top left (60% x 60%)
      end
    },
    {
      name = {"MacDown"},
      func = function(index, win)
          pushWindow(win,0,0,0.4,0.5) --top right
      end
    }
}

hs.urlevent.bind("zoomlayout", function()
    applyLayouts(layout_zoom_meeting)
    hs.alert("Zoom it up")
end)
